...
So, in release there is Tauri desktop version, much slower but with Direct R/W for HD so you can prepare images but always make copy of image as this thing frequently corrupts them, will fix that later, uder msdos you can copy files ok, under win it will destroy it usually.
